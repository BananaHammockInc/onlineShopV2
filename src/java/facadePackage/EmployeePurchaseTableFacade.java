 ...
 */
@Stateless
public class EmployeePurchaseTableFacade extends AbstractFacade<EmployeePurchaseTable> {
    ...
    public EmployeePurchaseTableFacade() {
        super(EmployeePurchaseTable.class);
    }
